    ...
    <div class="lower-box">
      ...
      <?php if( get_theme_mod( 'videography_filmmaker_date_hide',true) != '' || get_theme_mod( 'videography_filmmaker_comment_hide',true) != '' || get_theme_mod( 'videography_filmmaker_author_hide',true) != '' || get_theme_mod( 'videography_filmmaker_time_hide',true) != '') { ?>
        <div class="metabox py-1 px-2 mb-3">
          ...
          <?php if( get_theme_mod( 'videography_filmmaker_comment_hide',true) != '') { ?>
            <span class="entry-comments me-2"><i class="fas fa-comments me-1"></i> <?php comments_number( __('0 Comments','videography-filmmaker'), __('0 Comments','videography-filmmaker'), __('% Comments','videography-filmmaker') ); ?></span>
          <?php } ?>
      ...
      if(get_theme_mod('videography_filmmaker_post_content', 'Excerpt Content') == 'Excerpt Content'){ ?>
        <?php if(get_the_excerpt()) { ?>
          <p><?php $videography_filmmaker_excerpt = get_the_excerpt(); echo esc_html( videography_filmmaker_string_limit_words( $videography_filmmaker_excerpt, esc_attr(get_theme_mod('videography_filmmaker_post_excerpt_length','20')))); ?><?php echo esc_html( get_theme_mod('videography_filmmaker_button_excerpt_suffix','[...]') ); ?></p>
        <?php }?>
      <?php }?>
